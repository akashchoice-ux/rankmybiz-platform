    ...
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <aside className="hidden md:flex w-60 flex-col bg-slate-950 fixed top-0 bottom-0 left-0 z-40">
        ...
        <div className="p-4 border-t border-slate-800 flex flex-col gap-1">
          ...
          <LogoutButton className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-slate-500 hover:bg-slate-800 hover:text-white transition-colors w-full text-left">
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
