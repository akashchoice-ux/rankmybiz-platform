...
export const PACKAGES: Package[] = [
  {
    ...
    description: "Get your business found on Google and AI search — forever free.",
    features: [
      "1 verified business listing",
      "SEO-optimized listing page",
      "Schema.org structured data (Google + AI search)",
      "WhatsApp, phone & enquiry form",
      "1 city SEO page",
      "SSM-verified business badge",
      "Appear in directory & category pages",
    ],
    is_popular: false,
    is_active: true,
    sort_order: 1,
  ...
  },
  {
    ...
    description: "Stand out with photos and rank across all your service areas.",
    features: [
      "Everything in Free",
      "Up to 5 business photos",
      "Multi-city SEO pages (all service areas)",
  ...
  },
  {
    ...
    price: 149,
    billing_cycle: "monthly",
    description: "Your own products & services page — the full online presence.",
    features: [
      "Everything in Premium",
      "Up to 10 business photos",
      "Dedicated Products & Services page",
